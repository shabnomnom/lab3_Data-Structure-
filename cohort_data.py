...
def sort_by_cohort(filename):
    ...
    # extend is an operation and oes not return the a list
    # like append , do not assign it to a variable because it return nothing 
    #rstrip ***REMOVE WHITE SPACES*** after string 
    return all_students
...
def hogwarts_by_house(filename):
    ...
    all_hogwarts.extend([dumbledores_army, gryffindor, hufflepuff, ravenclaw, slytherin, ghosts 
    ,instructors]) 
